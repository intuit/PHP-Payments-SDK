   ...
   */
    ...
    public function __construct($ck, $cS, $oT, $oTS)
    {
        if (isset($ck)) {
            ...
            throw new InvalidArgumentException("Consumer key is not passed.");
        }

        if (isset($cS)) {
            $this->consumerSecret = $cS;
        } else {
            throw new InvalidArgumentException("Consumer Secret is not passed.");
        }

        if (isset($oT)) {
            $this->oauthToken = $oT;
        } else {
            throw new InvalidArgumentException("OAuth Token is not passed.");
        }

        if (isset($oTS)) {
            $this->oauthTokenSecret = $oTS;
        } else {
            throw new InvalidArgumentException("OAuth token Secret is not passed.");
        }
    ...
    public function setNounceForTest($nonce)
    {
        $this->oauthNonce = $nonce;
    }

    public function setTimeForTest($time)
    {
        $this->oauthTimeStamp = $time;
    }
}
